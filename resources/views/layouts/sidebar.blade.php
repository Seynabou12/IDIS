  ...
  <ul class="metismenu" id="menu">
    ...
    <li>
      ...
      <ul>
        ...
        <li> <a href="ecommerce-products-list.html"><i class="bi bi-arrow-right-short"></i>Assignments</a>
        </li>
      </ul>
    </li>
    <li>
    ...
    <li>
      ...
      <ul>
        ...
        <li> <a href="authentication-signin.html" target="_blank"><i class="bi bi-arrow-right-short"></i>Policies</a>
        </li>
        <li> <a href="authentication-signin.html" target="_blank"><i class="bi bi-arrow-right-short"></i>Audit Logs</a>
        </li>
      </ul>
    </li>
